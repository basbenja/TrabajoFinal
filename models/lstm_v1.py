...
class LSTMClassifier_v1(nn.Module):
    def __init__(self, input_size, num_layers, hidden_size, output_size, dropout=0.4):
        """
...
def define_lstm_v1_model(trial, input_size=2, output_size=1):
    ...
    return LSTMClassifier_v1(input_size, num_layers, hidden_size, output_size, dropout)
