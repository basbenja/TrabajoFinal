...
\title{
    ...
    \thanks{{
        {
            \protect\includegraphics[height=7mm]{logos/creative-commons.png}
        }
        \fontsize{10}{11}\selectfont  Esta obra está bajo una
...
\bigskip
\textbf{Palabras Clave}: Análisis de Redes Sociales, Aprendizaje Automático, Detección de
influenciadores, Detección de comunidades, Modelos de predicción, Twitter
\clearpage
