...
% Carátula
\input{caratula.tex}
\thispagestyle{empty} % sin número en carátula
\clearpage
...
\subfile{secciones/4-marco-experimental/3-metricas}

\section{Entrenamiento, evaluación y comparación} \label{sec:comparacion}
\subfile{secciones/4-marco-experimental/4-comparacion}

\section{Herramientas}
\subfile{secciones/4-marco-experimental/5-herramientas}
...
\subfile{secciones/5-resultados/exp7.tex}
