...
\cite{ai-a-modern-approach}. Esta operación suele agregarse antes de la aplicación de la
...
puede consultar el Capítulo ... de \cite{hands-on-ML-sklearn-tf}.
