...
\begin{enumerate}
    ...
    \item Parear las unidades del conjunto de tratamiento con unidades en el conjunto de no tratados que tienen los puntajes de propensión más cercanos. Estas unidades próximas se convierten en el grupo de control.
    \item Generar la estimación del programa como la diferencia promedio en los resultados entre las unidades del tratamiento y sus unidades de comparación correspondientes.
\end{enumerate}
\end{comment}
