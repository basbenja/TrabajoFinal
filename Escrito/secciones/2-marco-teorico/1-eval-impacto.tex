...
% Resumir los dos supuestos: menciuonar que no pueden ser probados directamente con los datos, pero existen aproximaciones como saber del area de estudio (filminas de David) o calcular diferencias en las variables observables X.
