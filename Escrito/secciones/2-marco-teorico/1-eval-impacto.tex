...
siguiente forma:
\begin{equation}
    \mathbb{E}\left[Y_i(0)|D_i=1, X_i\right] = \mathbb{E}\left[Y_i(0)|D_i=0, X_i\right],
\end{equation}
...
observables, es decir en\footnotemark :
\footnotetext{Nuevamente, omitiremos el subíndice \(i\).}
...
por los modelos económicos que describen el fenómeno bajo estudio, investigaciones
